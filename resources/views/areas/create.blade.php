...
@endif
    <div class="container">
            <div class="row justify-content-center">
                    <div class="col-md-11">
                            <div class="card">
                                        <div class="p-3 mb-2 bg-primary text-white"><h2><p class="text-center">Create Area</h2></div>
                                    <div class="card-body">
                                                ...
                                                @csrf       
                                                    ...
                                                    <br />
                                                        <div class="mb-3">
                                                        <label class="form-label">The Area's title</label>
                                                        <input type="text" name="title" placeholder="The title" class="form-control" value="{{old('title')}}" >
                                                        </div>
